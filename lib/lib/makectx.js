 ...
 */
function sendResponse(value     , response                ) {
...
module.exports = function makectx(
  ...
  ctx.response.setHeader = function (key        , value        ) {
    response.setHeader(key, value);
  },

  ctx.response.setStatus = function (num        ) {
  ...
  ctx.response.sendFile = function (filename        ) {
